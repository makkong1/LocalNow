...
## 로드맵·우선순위 (`priority-features-codebase-evaluation.md`)
추가 기능 제안(채팅 읽음, Redis TTL, 결제 상태, 알림 영속화 등)을 **실제 코드와 대조**해 검증하고, 포폴·구현 순서를 정리한 문서.

## 이력서·경력기술서 (`이력서-프로젝트-요약.md`)
프로젝트 한 줄 요약, 역할 문장 예시, 스킬 라인, 성과 불릿, 30초 면접 답변 스크립트.
